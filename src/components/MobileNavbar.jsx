...
function MobileNavbar({mobileMenuButton,setMobileMenuButton}) {
  return (
    <div className={mobileMenuButton ? 'absolute top-0 left-0 z-[10] duration-300 flex justify-between flex-col h-[100vh] w-full second_bg_color'
        : 'absolute top-0 left-[-100vw] z-[10] duration-300 flex justify-between flex-col h-[100vh] w-full second_bg_color'
    }>
